...
function BannerInfo() {
  return (
    <section className="absolute top-0 w-full h-[600px] sm:h-[350px] flex flex-col justify-center overflow-hidden sm:top-1">
      <div className="w-1/2 sm:hidden backdrop-blur-[2px] ml-10 rounded-3xl pl-24 sm:ml-0 sm:rounded-none pr-28 h-auto bg-[#00000067] flex flex-col justify-center relative sm:-bottom-20 sm:z-10 items-start py-12 sm:w-full sm:pl-4 sm:pr-4">
