...
function CollapsibleMenu() {
  ...
  return (
    <div className="w-full px-24 sm:px-3">
      <div className="px-7 py-4 pb-3">
        <div className="flex justify-center gap-10 sm:gap-0 sm:justify-between items-center">
          ...
          <FiMinus
            ...
            size={26}
            className={`cursor-pointer  ${hasCollaps ? "hidden" : "block"}`}
          /> */}

          <IoChevronDown onClick={() => setHasCollaps(false)} size={23} className={`cursor-pointer ${hasCollaps ? "block" : "hidden"}`} />
          <IoChevronDown onClick={() => setHasCollaps(true)} size={23} className={`cursor-pointer rotate-180 transition-all duration-500  ${hasCollaps ? "hidden" : "block"}`} />
        ...
        <div
          ref={collapseRef}
          className={`pt-2 flex flex-col gap-5 overflow-hidden transition-height duration-500 ${
            hasCollaps ? "h-0" : "h-[1982px]"
          }`}
        >
          <CollapsibleInfo
          ...
          <CollapsibleInfo heading="New Launches">
            <div
              dangerouslySetInnerHTML={{
                __html: `Products of luxurious bathware like designer ${generateLinkHtml("/basin-area/basin", "basin")}
                  , and trendy and high-functioning ${generateLinkHtml("/basin-area/faucets", "faucets")} give our products more
                  susceptibility for your home. ${generateLinkHtml("/basin-area/basin-fittings", "Basin fittings")} with our ${generateLinkHtml("/new-launches/new-launches", "new launches")}
                  make your experience more definitive since they make our services
                  more convenient for you. New products like ${generateLinkHtml("/showering-area/showers", "showers")} and ${generateLinkHtml("/showering-area/hand-shower", "hand showers")}
          ...
          <CollapsibleInfo heading="Basin products">
            <div
              dangerouslySetInnerHTML={{
                __html: `Our products of the bathroom and the area attached can be developed with reliable and long-lasting materials. As our designs for ${generateLinkHtml("/commercial/sensor-faucets", "sensor faucets")} along with ${generateLinkHtml("/commercial/urinals-sensors", "urinal sensors")} are the latest attraction for your bathware, it gives you modernized bathroom facilities with automatic systems. Our bathware products including the basins are made with durable materials while implementing style statements to it. High-quality products with proper materialistic balance help the products to become very eye-catching.`,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Toilet products">
            <div
              dangerouslySetInnerHTML={{
                __html: `Various ranges of toilet accessories with products are provided to you as our varieties like ${generateLinkHtml("/toilet-area/toilets", "toilets")} with designer ${generateLinkHtml("/toilet-area/toilet-seats", "toilet seats")} have been identified. The attributes of ${generateLinkHtml("/toilet-area/smart-toilet", "smart toilets")} and their installation have become further effective with us. Designs for our new collection range of ${generateLinkHtml("/basin-area/bathroom-mirror-cabinets", "bathroom mirror cabinets")} and other designs of ${generateLinkHtml("/basin-area/bathroom-vanity", "bathroom vanity")} make our collection more intriguing for your houses. ${generateLinkHtml("/showering-area/digital-showering", "Smart showers")} with extensive quality bathware make your experience more comfortable with style. Our designs for ${generateLinkHtml("/showering-area/diverters-trims", "diverters & trims")} give you more variety in your bathroom. Designs for ${generateLinkHtml("/showering-area/shower-doors", "shower doors")} make it further effective for you since the experience of luxury gains more susceptibility. ${generateLinkHtml("/showering-area/body-spray", "Spray showers")} are another attraction of our product ranges which makes the experience of luxury bathware more effective. `,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Kitchen products">
            <div
              dangerouslySetInnerHTML={{
                __html: `Kitchen setups with extensive features like ${generateLinkHtml("/commercial/flush-faucets-valves", "flush faucets and valves")} help our products gain more popularity in urban households. As our range of collections for ${generateLinkHtml("/commercial/sensor-faucets", "sensor faucets")} kitchen area settings is very resourceful for your usage, it helps to make kitchen spaces filled with utility. For our designer variations, the kitchen area gains more utility with stylish outlooks for urban ${generateLinkHtml("/kitchen-area/kitchen-faucet", "kitchen faucets")}. These products make your experience more resourceful since they provide satisfying services in the kitchen`,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Sustainability">
            <div
              dangerouslySetInnerHTML={{
                __html: `We provide products that are very reliable and convenient for personal usage as we build quality products with proper resources. Our products have variations for ${generateLinkHtml("/commercial/commercial-accessories", "commercial bathroom accessories")} that make you inclined to our brand services. With our products, you have the best safety and aesthetics that make your livelihood more content and satisfying.`,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Comfort">
            <div
              dangerouslySetInnerHTML={{
                __html: `Our services are aimed at your comfort as we provide you with the best kind of bathware products and accessories. Feasible services with extensive quality of comfort make our products more susceptible for future usage which gives us more stability and profundity in our services. Proper setups for ${generateLinkHtml("/showering-area/shower-fitting", "shower fittings")} are very reliable with us since we also give you the experience of ${generateLinkHtml("/wellness/steam", "steam")} showers with their proper features.`,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Showering area">
            <div
              dangerouslySetInnerHTML={{
                __html: `Different ranges of products make our services very compatible for your use since our services for ${generateLinkHtml("/showering-area/shower-doors", "shower doors")} give you more variety in bathroom setups. Our range of ${generateLinkHtml("/commercial/customized-mirror", "customized mirrors")} makes it more prominent for you since it gives a touch of personalization to your bathroom.`,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Toilet area">
            <div
              dangerouslySetInnerHTML={{
                __html: `Modernized systems for ${generateLinkHtml("/toilet-area/cisterns-and-flushing", "cisterns and flushing")} with the technology of ${generateLinkHtml("/smart-products/electronic-bidet-seats", "electronic bidet seats")} make your experience more satisfying in your toilet spaces. As our products are more integrated with the urban lifestyle, they give you the best quality of urban styling.`,
              }}
            />
          </CollapsibleInfo>
          ...
          <CollapsibleInfo heading="Smart products">
            <div
              dangerouslySetInnerHTML={{
                __html: `Our product range also includes ${generateLinkHtml("/wellness/bathtubs", "bathtubs")} that give you the most satisfying experience in your bathing zone. With our range of ${generateLinkHtml("/wellness/bathtub-fillers", "bathtub fillers")}, the experience of satisfactory bathroom setups becomes more susceptible, giving you a better experience in your home space.`,
              }}
            />
          </CollapsibleInfo>
